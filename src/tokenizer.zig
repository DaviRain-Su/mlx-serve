...
pub fn loadTokenizer(allocator: std.mem.Allocator, io: std.Io, model_dir: []const u8) !Tokenizer {
    ...
    const content = try file_reader.interface.allocRemaining(allocator, .limited(256 * 1024 * 1024));
